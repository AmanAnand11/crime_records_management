        ...
        <div className="row">
              ...
              <div className="card-content">
                <form onSubmit={onSubmit}>
                  <div className="input-field">
                    <input type="text" id="caseId" value={crime_id} onChange={(evt) => setCrimeId(evt.target.value)} required />
                    <label htmlFor="email">Case ID</label>
                  </div>
                  <div className="input-field">
                    <input type="text" id="timestamp" value={timestamp} readOnly onChange={(evt) => setTimestamp(evt.target.value)} required />
                    {/* <label htmlFor="email">Time Stamp</label> */}
                  </div>
                  <div className="input-field">
                    <input type="text" id="offCode" value={offense_code} onChange={(evt) => setOffenseCode(evt.target.value)} required />
          ...
          <div className="col s6">
            <div className="card reportCard">
              ...
              <div className="card-content">
                <div className="input-field ">
                  <textarea id="report" className="textAreaHeight" value={description} onChange={(evt) => setDescription(evt.target.value)} required></textarea>
                  </div>
                            </div>
                        </div>
                    </div>
